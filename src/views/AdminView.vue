              ...
              <div class="modal-body">
                ...
                <form @submit.prevent="handleAddProduct">
                  ...
                  <div class="mb-3">
                    ...
                    <input v-model="newProduct.amount" type="number" class="form-control" id="amount" required>
                  </div>
                  <div class="mb-3">
                    <label for="img_url" class="form-label">Image URL</label>
                    <input v-model="newProduct.prodUrl" type="text" class="form-control" id="img_url" required>
                  </div>
              ...
              <div class="modal-body">
                ...
                <form @submit.prevent="handleEditProduct">
                  ...
                  <div class="mb-3">
                    ...
                    <input v-model="currentProduct.amount" type="number" class="form-control" id="editAmount" required>
                  </div>
                  <div class="mb-3">
                    <label for="editImgUrl" class="form-label">Image URL</label>
                    <input v-model="currentProduct.prodUrl" type="text" class="form-control" id="editImgUrl" required>
                  </div>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(product, index) in products" :key="product.prodID">
                ...
                <td>
                  <button class="btn btn-danger" @click="handleDeleteProduct(product.prodID)">
                    Delete
                  </button>
                </td>
              </tr>
