...
const saveEditedProduct = async () => {
  currentProduct.value = { ...currentProduct.value }; // update currentProduct.value with edited values
  await store.dispatch("updateProduct", currentProduct.value);
  products.value = store.state.products;
  currentProduct.value = { prodName: "", Category: "", prodDescription: "", amount: 0, prodUrl: "" };
};
